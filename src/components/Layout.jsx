  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-blue-50 flex flex-col">
      ...
      <header className="bg-indigo-600 text-white shadow-lg sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-3 sm:px-6 py-2.5 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity shrink-0">
            <span className="text-xl sm:text-2xl">📚</span>
            <div>
              <h1 className="text-sm sm:text-base font-bold leading-tight">小学英语学习助手</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            {!isHome && (
              <Link
                to="/"
                className="flex items-center gap-1 bg-white/20 hover:bg-white/30 text-white px-3 py-1.5 rounded-full text-xs sm:text-sm transition-colors shrink-0"
              >
                <span>🏠</span>
